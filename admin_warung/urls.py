...
urlpatterns = [
    ...
    path('detail-barang-admin', views.detail_barang_admin_view, name='detail-barang-admin'),
    path('hapus-barang', views.hapus_barang_view, name='hapus-barang'),
    path('tambah-barang', views.tambah_barang_view, name='tambah-barang'),
    path('ubah-barang', views.ubah_barang_view, name='ubah-barang'),
